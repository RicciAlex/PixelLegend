...
public:
	...
	void SetPresentRevolutionAngle(const float fAngle);								//現在の公転角度の取得処理
	...
	void SetAnimPattern(const int PatternNum);										//アニメーションパターンの設定処理
	void MoveTexCoordinates(const D3DXVECTOR2 move);								//テクスチャのUV座標の移動量の設定処理
	bool GetFlipX(void);															//X軸が反転しているかどうかの取得処理
	void FlipX(void);																//X軸の反転
	void FlipY(void);																//Y軸の反転
...
private:
	...
	static char* m_paTextPass[CObject::TextTypeMax];			//テクスチャの相対パス

	void UpdateTexture(void);									//テクスチャの更新処理
	...
	D3DXVECTOR2 m_dimension;									//ポリゴンの幅と高さ
	//================================================================================================================
	//================================================================================================================
	...
	D3DXVECTOR2 m_textureTranslation;							//テクスチャUV座標の移動量
	bool m_bFlipX;												//X軸が反転しているかどうか
	bool m_bFlipY;												//Y軸が反転しているかどうか
	...
	//================================================================================================================
	//静的変数
	static LPDIRECT3DTEXTURE9 m_pTextureAll[TextTypeMax];		//テクスチャへのポインタの配列
	//================================================================================================================
